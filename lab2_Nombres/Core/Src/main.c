  ...
  /* USER CODE BEGIN WHILE */
    ...
    /* USER CODE BEGIN 3 */
		  ...
		  switch(displayActual){
			  case 1:
				valorLetra = getLetra(nombreActual[token+0]);
			  break;
			  case 2:
				valorLetra = getLetra(nombreActual[token+1]);
			  break;
			  case 3:
				valorLetra = getLetra(nombreActual[token+2]);
			  break;
			  case 4:
				valorLetra = getLetra(nombreActual[token+3]);
			  break;
			  case 5:
				valorLetra = getLetra(nombreActual[token+4]);
			  case 6:
			  break;
				valorLetra = getLetra(nombreActual[token+5]);
			  break;
			  case 7:
				valorLetra = getLetra(nombreActual[token+6]);
			  break;
			  case 0:
				valorLetra = getLetra(nombreActual[token+7]);
			  break;
			  default:
				valorLetra = 0;
		  }
